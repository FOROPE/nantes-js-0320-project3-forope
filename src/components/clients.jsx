  ...
  return (
    <ClientContainer>
      <ClientText>
        ...
        déçu. lov keur, on vous aime. Pour vous présenter loffre Alan adaptée à
        vos besoins, on a besoin den savoir un tout petit peu plus ! Toutes ces
        entreprises nous ont fait confiance. HE HE, on se la raconte, pourquoi
        pas vous, vous ne serez pas déçu. lov keur, on vous aime.
      </ClientText>
      <Logos>
